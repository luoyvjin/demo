            ...
            <div style={{padding: '0 30px'}}>
                ...
                <div className='row'>
                    <div className="col-lg-6 col-sm-6 col-md-6">
                        ...
                        <div>
                            <input type="text" placeholder='github username' value={this.state.inp1} onChange={this.onValue1Change} style={{width: '60%',height:'40px'}} onKeyUp={this.key1Up}/>
                    ...
                    <div className="col-lg-6 col-sm-6 col-md-6">
                        ...
                        <div>
                            <input  type="text" placeholder='github username' value={this.state.inp2} onChange={this.onValue2Change} style={{width: '60%',height:'40px'}} onKeyUp={this.key2Up}/>
